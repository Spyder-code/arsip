          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-laporan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{route('laporan.minggu')}}">Laporan Mingguan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('laporan.bulan') }}">Laporan Bulanan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('laporan.tahun') }}">Laporan Tahunan</a>
                </li>
              </ul>
            </div>
          </li>
